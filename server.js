...
message.channel.send(support);
  ...
  if(cmd === `${prefix}invitebot`) {
  	message.channel.send('HERE THE LINK OF IMUSIC PLAY : https://discordapp.com/api/oauth2/authorize?client_id=520978079863275522&permissions=2146958839&scope=bot')
