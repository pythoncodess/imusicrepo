...
message.channel.send(support);
  ...
  if(cmd === `${prefix}invitebot`) {
  	message.channel.send('HERE THE LINK OF MUSIC PLAY: https://discordapp.com/api/oauth2/authorize?client_id=521222454652436481&permissions=2146958678&scope=bot')'
  	
  }
  
});

client.login("NTIxMjIyNDU0NjUyNDM2NDgx.Du5SDw.YpLbDVP31F2wNFi64S9bvSlqT9w");
