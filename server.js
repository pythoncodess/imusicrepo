...
client.on('ready', () => {
client.setActivity("Master Joker | im!",{type:"streaming"});
...
message.channel.send(support);
  ...
  if(cmd === `${prefix}invitebot`) {
  	message.channel.send(`Check dm 📨$ {message.author.id}`)
  	Invite Link:- 	https://discordapp.com/api/oauth2/authorize?client_id=520978079863275522&permissions=2146958839&scope=bot
  	
  }
  
});

client.login("NTIwOTc4MDc5ODYzMjc1NTIy.Du1vaA.xGO0sfzQfNbbRQL4cT2HjKcOf6g");
